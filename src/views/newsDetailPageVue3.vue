<template>
  ...
  <section>
    <nav class="navigation-item">
      ...
      <router-link :to="'/newsVue3'" >太陽人快報</router-link>
      <i class="bi bi-chevron-double-right"></i>
  ...
  <section class="newsSlider">
    ...
    <div class="d-flex position-relative">
        ...
        <transition-group name="flip-list" tag="ul" class="slider-box">
          <li class="slider-card" :class="{'sliderCardWidth': screenWidth < 768 }" v-for="item in slideData" :key="item.id">
            <img class="slider-img" :src="imgData[item.ref].img" :alt="imgData.title"/>
            <div class="slider-hover">
              <router-link target="_blank" class="d-flex flex-column justify-content-center" :to="{name:'newsDetailPageVue3', params:{id: imgData[item.ref].id}}" style="width:100%">
