        ...
        <div class="intro d-flex align-items-end justify-content-center">
            <div class="intro-m174 d-flex justify-content-center">
                <div class="d-flex justify-content-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="m-55">
                            <p class="mb-30 text-success intro-text">
                                我們秉持著環境與經濟共贏的精神，以日本職人技術，台灣在地深耕為念，透過創新的商業模式與多方力量的串聯，
                                為環境永續及能源轉型帶來正面的影響。
                            </p>
                            <p class="text-end mb-0"><small class="d-flex flex-wrap justify-content-end intro-text">—— 太陽人全民電廠創辦人&ensp;<span>陳威丞，2013年</span></small></p>
                        </div>
                    </div>
        ...
        <div class="see">
            ...
            <div class=" mb-50">
                <div class="d-flex flex-wrap card-mobil">
                    <div class="card rounded border-0 card-padding m-1" :style="{ background: 'url(' + see.logo + ')' }">
                    ...
                    <div class="card rounded border-0 card-padding m-1" :style="{ background: 'url(' + see.logo + ')' }">
                        ...
                        <p class="mb-0">參與日光循環公益專案，同時為環境跟能源永續盡一份心力，也因為有專案收益的支持，我們能持續不間斷的陪伴偏鄉孩子勇敢追夢，透過合唱跟音樂教育構築孩子對人生夢想的藍圖。<br/> 讓更多志同道合的教師跟夥伴耕耘在地，攜手散布音樂計劃的理念到偏鄉各地方。</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="intention-text">
                        <div class="mb-100  d-flex mobile-wrap-768">
                            ...
                            <div class='embed-container'>
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/1acF5emYRDY" title="光芒-陳威丞" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            <!-- [End] Youtube影片嵌入 -->
                        </div>
                        <div class="d-flex flex-row-reverse mobile-wrap-768 mb-100">
                            ...
                            <!-- [Start] Youtube影片嵌入 -->
                            <div class='embed-container'>
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/jVebYL67ghw" title="光芒-陳威丞" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            <!-- [End] Youtube影片嵌入 -->
                        </div>
                    </div>
        ...
        <div class="intro ">
            <div class="intro-m174 ">
                <div class="d-flex justify-content-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="m-55">
                            <p class="mb-14 text-success intro-text">讓民間力量落實於能源轉型，達成環境與經濟的共贏！</p>
                        ...
                        <div class="d-flex mobile-column flex-row-reverse">
                            <div class="content-width ">
                                ...
                                <p>
                                    ...
                                    佐賀、長崎、大分等地的日本綠能電廠亦先後完工 掛表，共 35 位一般社會大眾一同參與並證明了民間 力量落實能源轉型的可行性與價值性。
                                </p>
                            </div>
...
<style>.embed-container { position: relative; height: 300px; overflow: hidden; width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style>
